...
def step_3(data: schemas.OnboardingStep3, db: Session = Depends(get_db), current_user: models.User = Depends(get_current_user)):
    valid_categories = ['restaurant', 'cafe', 'fastfood', 'bar', 'bakery', 'foodcourt', 'finedining', 'foodtruck', 'cloudkitchen', 'jewellery', 'tax / ca firm', 'education', 'hotel', 'spa', 'salon', 'retail', 'gym', 'medical', 'real_estate', 'doctor clinic', 'grocery/general retail', 'dental clinic', 'other']
